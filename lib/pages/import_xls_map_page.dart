...
class ImportXlsMapPageState extends State<ImportXlsMapPage> {
  ...
  Map<String, int?> _accountMapping = {};
        ...
        children: [
          ...
          Padding(
            ...
            child: Row(
              ...
              children: [
                TextButton(
                  onPressed: () {}, // TODO: Navigare alla gestione account
                  child: Text("Manage Accounts"),
                ),
                TextButton(
                  onPressed: () {}, // TODO: Navigare alla gestione categorie
            ...
            child: DropdownButton<int>(
              ...
              items: _existingCategories.map((category) => DropdownMenuItem(
                ...
                child: Text(
                  ...
                  style: TextStyle(color: category.type == TransactionType.EXPENSE ? Colors.black : Colors.green[900]),
                ),
              )).toList(),
            ),
          ),
